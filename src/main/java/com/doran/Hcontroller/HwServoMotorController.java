...
public class HwServoMotorController {
	...
	public ResponseEntity<Map<String, Object>> updateServoDegree(@RequestBody Map<String, Integer> request) {
		...
		if (request.containsKey("degree")) {
			...
			responseMap.put("degree", degree);
		} else {
			responseMap.put("status", "error");
			responseMap.put("message", "degree가 필요합니다.");
